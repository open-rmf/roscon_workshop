...
package_name = 'roscon_fleet_adapter'
...
setup(
    ...
    entry_points={
        'console_scripts': [
            'fleet_adapter=roscon_fleet_adapter.fleet_adapter:main',
            'fleet_manager=roscon_fleet_adapter.fleet_manager:main',
            'easy_fleet_adapter='
            'roscon_fleet_adapter.easy_fleet_adapter:main',
        ],
    },
)
